...
Vertreten durch den Geschäftsführer Konstantin Pinski.
...
Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen. Die Erfassung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der technisch fehlerfreien Darstellung und der Optimierung seiner Website – hierzu müssen die Server-Log-Files erfasst werden. Die Speicherdauer dieser Daten beträgt 14 Tage.
...
### Tischreservierung über Zenchef

Für die Reservierung von Tischen nutzen wir den Dienst Zenchef der Zenchef SAS, 63 avenue de Villiers, 75017 Paris, Frankreich. Das Reservierungsfenster wird erst geladen, wenn Sie auf eine der Schaltflächen „Tisch reservieren“ klicken. Bis zu diesem Klick werden keine Daten an Zenchef übertragen und es werden keine Cookies von Zenchef gesetzt. Mit dem Klick willigen Sie in das Laden des Dienstes ein (Art. 6 Abs. 1 lit. a DSGVO). Dabei wird Ihre IP-Adresse an Zenchef übermittelt; zudem können technische Informationen wie Browsertyp und Betriebssystem sowie Cookies verarbeitet werden, die für den Betrieb des Reservierungsfensters erforderlich sind. Die von Ihnen im Reservierungsformular angegebenen Daten – insbesondere Name, E-Mail-Adresse, Telefonnummer, Datum, Uhrzeit, Anzahl der Personen und etwaige Anmerkungen – verarbeiten wir zur Durchführung Ihrer Reservierung und damit zur Erfüllung eines Vertrags beziehungsweise zur Durchführung vorvertraglicher Maßnahmen (Art. 6 Abs. 1 lit. b DSGVO). Zenchef verarbeitet diese Daten in unserem Auftrag auf Grundlage eines Vertrags über die Auftragsverarbeitung nach Art. 28 DSGVO. Ihre Reservierungsdaten werden gelöscht, sobald sie für die genannten Zwecke nicht mehr erforderlich sind und keine gesetzlichen Aufbewahrungsfristen entgegenstehen. Weitere Informationen zum Umgang mit Ihren Daten durch Zenchef finden Sie in der Datenschutzerklärung des Anbieters unter [zenchef.com/de/privacy-policy](https://www.zenchef.com/de/privacy-policy); den Datenschutzbeauftragten von Zenchef erreichen Sie unter privacy@zenchef.com.
